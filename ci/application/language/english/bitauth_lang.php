...
/**
 * Company Validation Error Messages
 */
$lang['bitauth_unique_group']		= 'The %s field must be unique.';
$lang['bitauth_groupname_required']	= 'Company name is required.';
/**
...
# for THRONE BMS
$lang['as_admin']					= 'enter as admin';
$lang['incorrect_admin']			= 'admin password is incorrect or admin does not exists';
