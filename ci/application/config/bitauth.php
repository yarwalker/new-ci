 ...
 */
$config['table'] = array(
	'users'		=> 'ct_bitauth_users',		// Required user information (username, password, etc)
	'data'		=> 'ct_bitauth_userdata',	// Optional user information (profile)
	'groups'	=> 'ct_bitauth_groups',		// Groups
	'assoc'		=> 'ct_bitauth_assoc',		// Users -> Groups associations
	'logins'	=> 'ct_bitauth_logins'		// Record of all logins
);
